...
export function HomeScreen() {
	...
	return (
		<Screen edges={['left', 'right']}>
			<FadeInView><HomeHeader /></FadeInView>
			...
			<Section
				...
				seeAll
				onPressSeeAll={() => router.push('/(tabs)/catalog?level=cards&mode=recentlyViewed')}
			>
			...
			{data.wishlist.length > 0 ? (
				<Section
					...
					title="Wishlist"
					seeAll
					onPressSeeAll={() => router.push('/(tabs)/catalog?level=cards&mode=wishlist')}
				>
			...
			{data.missingCards.length > 0 ? (
				<Section
					...
					title="Missing Cards"
					seeAll
					onPressSeeAll={() => router.push('/(tabs)/catalog?level=cards&mode=missingCards')}
				>
